...
public class UserFileService  extends ServiceImpl<UserFileMapper, UserFile> implements IUserFileService {
    ...
    @Override
    public List<Map<String, Object>> searchFileList(UserFile userFile, Long beginCount, Long pageCount) {
        return userFileMapper.searchFileList(userFile, beginCount, pageCount);
    }
